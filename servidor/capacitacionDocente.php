...
<head>
    ...
    <title>Capacitaci&oacuten Docente</title>
...
<body>
    <header>
	  ...
	  <?php
		if($_SESSION["activadaA"] != "v"){//para diferenciar en que sesion estamos
        ...
        <section id="contenidos">
             <div class="container">
				...
				?>
						<?=$tabla?>
				<?php
					if($A == 1){//si el administrador ingresó	
				?>		
				...
				?>
					...
					?>
						<a href="?tl=1" class="waves-effect waves-light btn-small">Ver registros previos</a>
						...
						<form id="formObtComp" autocomplete="off" method = "POST" action = "capacitacionDocente.php">
                                <div class="col s12 l6 input-field">
									 ...
									 <select name = "tipo" id = "tipo" class="browser-default" required>
										...
										<?=$obj->traerSelectCapacitaciones($t)?>
									</select>
                                     </div>
                                ...
                                <div class="col s12 l6 input-field">
                                  ...
                                  <div class="col s12 l6 input-field">
                                        ...
                                        <input type="text" required value="<?=$p?>" placeholder = "País" id="pais" name="pais" data-validetta="required,,minLength[4],maxLength[50]">
                                  </div>
								  ...
								  <?php
									if($A == 1){
									?>	
											<input type = "hidden" id="oculto1" name="oculto1" value="<?=$A?>"/>
									<?php
									}
									?>
                                ...
                                <div class="col s12 8 input-field ">
                                        ...
                                        <a href="./capacitacionDocente.php" class="btn red" style="width:100%;">CANCELAR</a>
										<?php
										}else{
										?>
										<a href="?tl=1&A=1">Ver capacitaciones</a>
										<?php
										}
										}
										?>

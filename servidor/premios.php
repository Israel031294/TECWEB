<?php
	...
	if($_SESSION["activada"]=="v")
	{
		...
		$cantidad=$objeto->cantidadPremio($idUsuario);
       ...
       $descri =  isset($_REQUEST["descri"]) ? $_REQUEST["descri"] : ""; //descripcion
		...
		$respuesta="Premios, distinciones o reconocimientos recibidos";	
		...
		if($oculto!=""){
      $respuesta=$objeto->registraPremio($idUsuario,$anio,$nombre,$descri,$oculto,$identificadorRegistro);
      
				$cantidad=$objeto->cantidadPremio($idUsuario);
				$tabla=$objeto->traerPremio($idUsuario);
		}
?>
...
<head>
    ...
    <title>Premios, distinciones o reconocimientos recibido</title>
...
?>
            ...
            <h5 class="blue-grey-text center-align">Incluir los datos relevantes, nombre del premio, organismo que lo otorga, motivos por se otorga, etc. </h5>
                    <hr>
             </div>
      </section>
    </header>
        ...
        <section id="contenidos">
             <div class="container">
                ...
                <?php 
                        ...
                        <form id="formObtComp" autocomplete="off" method="post" action="premios.php">
                        ...
                        <div class="col s12 l6 input-field">
                                          <i class="fa fa-award fa prefix"></i>
                                ...
                                <div class="col s12 8 input-field ">
                                        ...
                                        <a href="./premios.php" class="btn red" style="width:100%;">CANCELAR</a>
                                </div>
        ...
        <input type="hidden" value="2" name="oculto">
         ...
         <?php
					...
					?>
								...
								<a href='?v=1'>Agregar premio</a> <br>
								<?=$tabla?>
					<?php
							}
						}
